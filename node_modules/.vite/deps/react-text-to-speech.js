...
function useSpeech({
  ...
  const stringifiedVoices = (0, import_react2.useMemo)(() => JSON.stringify(voiceURI), [voiceURI]);
  ...
  const reactContent = (0, import_react2.useMemo)(() => highlightedText(text), [speakingWord, key, highlightText, showOnlyHighlightedText]);
