...
// node_modules/@zener/nepali-date/dist/index.mjs
var dist_exports = {};
__export(dist_exports, {
  AD_MONTH: () => AD_MONTH,
  AD_MONTH_FULL: () => AD_MONTH_FULL,
  AD_MONTH_NEPALI: () => AD_MONTH_NEPALI,
  ENGLISH_NEPALI_MONTH: () => ENGLISH_NEPALI_MONTH,
  ENGLISH_WEEK: () => ENGLISH_WEEK,
  ENGLISH_WEEK_FULL: () => ENGLISH_WEEK_FULL,
  NEPALI_DIGITS: () => NEPALI_DIGITS,
  NEPALI_MONTH: () => NEPALI_MONTH,
  NEPALI_TODAY: () => NEPALI_TODAY,
  NEPALI_WEEK: () => NEPALI_WEEK,
  NEPALI_WEEK_FULL: () => NEPALI_WEEK_FULL,
  default: () => nepali_date_default2,
  formatADDate: () => formatADDate,
  lowerADDate: () => lowerADDate,
  startDateBS: () => startDateBS,
  toAD: () => findADfromBS,
  toBS: () => findBSfromAD,
  yearMonthDays: () => yearMonthDays
});
var startDateAD = 19430414;
var startDateBS = 20000101;
var lowerADDate = -621355968e5;
var yearMonthDays = [
...
var ENGLISH_WEEK = ["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"];
var ENGLISH_WEEK_FULL = [
  "Sunday",
  "Monday",
  "Tuesday",
  "Wednesday",
...
var NEPALI_TODAY = "आज";
var reg = /^\d{4}-(0[1-9]|1[0-2])-(0[1-9]|[12]\d|3[012])$/;
var engToNepaliNumber = (number2) => {
  return number2.toString().split("").map((n) => NEPALI_DIGITS[n]).join("");
};
var engToNepNumberFullDate = (date) => {
  return date.split("").map((d) => {
    if (d !== "-") {
      return NEPALI_DIGITS[d];
    }
    return "-";
  }).join("");
};
var parseDate = (date) => {
  if (reg.test(date)) {
    ...
    const m2 = parseInt(dd[1], 10);
    const d = parseInt(dd[2], 10);
    return { date: d, year: y, month: m2 };
  }
  return null;
};
var padZero = (num) => `${num}`.padStart(2, "0");
var convertLang = (value, lang) => lang === "en" ? value : engToNepaliNumber(value);
var formatADDate = (date, format = "", lang = "en") => {
  ...
  const MMM = lang === "en" ? AD_MONTH[date.getMonth()] : AD_MONTH_NEPALI[date.getMonth()];
  const MMMM = lang === "en" ? AD_MONTH_FULL[date.getMonth()] : AD_MONTH_NEPALI[date.getMonth()];
  const d = convertLang(end, lang);
  const dd = lang === "en" ? ENGLISH_WEEK[end] : NEPALI_WEEK[end];
  const ddd = lang === "en" ? ENGLISH_WEEK_FULL[end].slice(0, 3) : NEPALI_WEEK[end];
...
var toInt = (value) => ~~value;
var yearDivider = 1e4;
var monthDivider = 100;
var padTwo = (v) => `${v}`.padStart(2, "0");
var padFour = (v) => `${v}`.padStart(4, "0");
var stringDateFormatter = ({ year, month, date }) => `${padFour(year)}-${padTwo(month)}-${padTwo(date)}`;
var getDateFromNumber = (n) => {
...
var getDays = (a, b) => (a.getTime() - b.getTime()) / (1e3 * 3600 * 24) + 1;
var nepaliDateExtractor = (datestring) => {
  if (!datestring) {
  ...
  if (year < startBSDate.year || year > startBSDate.year + yearMonthDays.length - 1 || date <= 0 || date > 32 || month > 12 || month < 0) {
    throw new Error("Invalid Date");
  }
  return { year, month, date };
};
var findADfromBS = (date) => {
  ...
  return {
    ...dateData,
    toString: () => stringDateFormatter({ ...dateData, month: dateData.month + 1 })
  };
};
var findBSfromAD = (date) => {
  ...
  const startBSDate = getDateFromNumber(startDateBS);
  if (yearIndex + startBSDate.year > startBSDate.year + yearMonthDays.length - 1 || yearIndex + startBSDate.year < startBSDate.year) {
    throw new Error("Invalid date");
  }
...
var manipulate = (currentDate, value) => {
...
var manipulateDays = (currentDate, days) => {
...
var manipulateWeeks = (currentDate, weeks) => {
...
var manipulateMonths = (currentDate, months) => {
...
var manipulateYears = (currentDate, years) => {
...
var _year, _month, _date, _adDate, _setADDate, __NepaliDate_instances, getMonthByIndex_fn, getDayByIndex_fn, manipulate_fn, _a;
var NepaliDate = (_a = class {
  constructor(yearOrValue, month, date) {
    __privateAdd(this, __NepaliDate_instances);
    __privateAdd(this, _year, 2e3);
    __privateAdd(this, _month, 0);
    __privateAdd(this, _date, 1);
    __privateAdd(this, _adDate, /* @__PURE__ */ new Date());
    __privateAdd(this, _setADDate, () => {
      __privateSet(this, _adDate, new Date(
        findADfromBS(
          stringDateFormatter({
            year: __privateGet(this, _year),
            month: __privateGet(this, _month) + 1,
    ...
    if (typeof yearOrValue === "number") {
      __privateSet(this, _year, yearOrValue);
      __privateSet(this, _month, month);
      __privateSet(this, _date, date);
      __privateGet(this, _setADDate).call(this);
    } else if (typeof yearOrValue === "string" || yearOrValue instanceof _a || yearOrValue instanceof Date) {
      if (typeof yearOrValue === "string") {
        const parsed = parseDate(yearOrValue);
        if (!parsed) {
          throw new Error("Invalid date");
        }
        __privateSet(this, _year, parsed.year);
        __privateSet(this, _month, parsed.month - 1);
        __privateSet(this, _date, parsed.date);
      } else if (yearOrValue instanceof _a) {
        __privateSet(this, _year, __privateGet(yearOrValue, _year));
        __privateSet(this, _month, __privateGet(yearOrValue, _month));
        __privateSet(this, _date, __privateGet(yearOrValue, _date));
      } else {
        ...
        __privateSet(this, _year, d.year);
        __privateSet(this, _month, d.month);
        __privateSet(this, _date, d.date);
      }
    } else {
      const today = getCurrentDate({ type: "np" });
      __privateSet(this, _year, today.year);
      __privateSet(this, _month, today.month);
      __privateSet(this, _date, today.date);
    }
    __privateGet(this, _setADDate).call(this);
  }
  format(format = "", lang = "en") {
    if (!format) {
      return this.toString(lang);
    }
    const date = padZero(this.getDate("en"));
    const month = padZero(__privateGet(this, _month) + 1);
    const replacements = {
      DD: lang === "en" ? date : engToNepaliNumber(date),
      D: this.getDate(lang),
      YYYY: String(this.getFullYear(lang)),
      YY: String(this.getFullYear(lang)).slice(-2),
      M: lang === "en" ? __privateGet(this, _month) + 1 : engToNepaliNumber(__privateGet(this, _month) + 1),
      ...
      d: this.getDay(lang),
      // Abbreviated day name
      dd: lang === "en" ? this.getDayNameFull(lang).slice(0, 2) : this.getDayName(lang),
      // Abbreviated day name
      ddd: lang === "en" ? this.getDayNameFull(lang).slice(0, 3) : this.getDayName(lang),
      // Abbreviated day name
      dddd: this.getDayNameFull(lang)
      // Full day name
    };
    const tokenReg = /(\[.*?\])|(MMMM|MMM|dddd|ddd|dd|d|DD|D|MM|M|YYYY|YY)/g;
    return format.replace(tokenReg, (match, literal) => {
  ...
  toJson(lang = "en") {
    const d = {
      year: __privateGet(this, _year),
      month: __privateGet(this, _month),
      date: __privateGet(this, _date),
      day: __privateGet(this, _adDate).getDay()
    };
    switch (lang) {
      case "en":
        return d;
      ...
      default: {
        return {
          year: engToNepaliNumber(__privateGet(this, _year)),
          month: engToNepaliNumber(__privateGet(this, _month)),
          date: engToNepaliNumber(__privateGet(this, _date)),
          day: engToNepaliNumber(__privateGet(this, _adDate).getDay())
        };
      }
    }
  }
  ...
  getFullYear(lang = "en") {
    return lang === "en" ? __privateGet(this, _year) : engToNepaliNumber(__privateGet(this, _year));
  }
  getMonth(lang = "en") {
    return lang === "en" ? __privateGet(this, _month) : engToNepaliNumber(__privateGet(this, _month));
  }
  getMonthName(lang = "en") {
    return __privateMethod(this, __NepaliDate_instances, getMonthByIndex_fn).call(this, __privateGet(this, _month), lang);
  }
  getDate(lang = "en") {
    return lang === "en" ? __privateGet(this, _date) : engToNepaliNumber(__privateGet(this, _date));
  }
  getDay(lang = "en") {
    return lang === "en" ? __privateGet(this, _adDate).getDay() : engToNepaliNumber(__privateGet(this, _adDate).getDay());
  }
  getDayName(lang = "en") {
    return __privateMethod(this, __NepaliDate_instances, getDayByIndex_fn).call(this, __privateGet(this, _adDate).getDay(), lang, false);
  }
  getDayNameFull(lang = "en") {
    return __privateMethod(this, __NepaliDate_instances, getDayByIndex_fn).call(this, __privateGet(this, _adDate).getDay(), lang, true);
  }
  subtract(value, type) {
    const v = -Math.abs(value);
    const m2 = __privateMethod(this, __NepaliDate_instances, manipulate_fn).call(this, v, type);
    return new _a(m2.year, m2.month, m2.date);
  }
  add(value, type) {
    const v = Math.abs(value);
    const m2 = __privateMethod(this, __NepaliDate_instances, manipulate_fn).call(this, v, type);
  ...
  setDate(date) {
    if (date > 0) {
      if (date >= __privateGet(this, _date)) {
        const dateToAdd = date - __privateGet(this, _date);
        try {
          const {
            year,
            month,
  ...
  setMonth(month) {
    if (month >= 0) {
      if (month >= __privateGet(this, _month)) {
        const monthToAdd = month - __privateGet(this, _month);
        try {
          const {
            year,
            month: m2,
      ...
      __privateSet(this, _month, 0);
      try {
        const { year, month: m2, date } = this.subtract(month, "m").toJson("en");
        __privateSet(this, _date, date);
        __privateSet(this, _year, year);
        __privateSet(this, _month, m2);
        __privateGet(this, _setADDate).call(this);
...
}, _year = new WeakMap(), _month = new WeakMap(), _date = new WeakMap(), _adDate = new WeakMap(), _setADDate = new WeakMap(), __NepaliDate_instances = new WeakSet(), getMonthByIndex_fn = function(index2, lang = "en") {
  if (index2 < 0 || index2 > 11) {
    throw new Error("Invalid month");
  }
  return lang === "en" ? ENGLISH_NEPALI_MONTH[index2] : NEPALI_MONTH[index2];
}, getDayByIndex_fn = function(index2, lang = "en", full = false) {
  if (index2 < 0 || index2 > 6) {
    throw new Error("Invalid day");
  }
  if (full) {
    return lang === "en" ? ENGLISH_WEEK_FULL[index2] : NEPALI_WEEK_FULL[index2];
  }
  return lang === "en" ? ENGLISH_WEEK[index2] : NEPALI_WEEK[index2];
}, manipulate_fn = function(v, type) {
...
var nepali_date_default = NepaliDate;
var nepali_date_default2 = nepali_date_default;

// node_modules/@zener/nepali-datepicker-react/dist/index.mjs
...
var Slot = React13.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React13.isValidElement(newElement) ? React13.cloneElement(newElement, void 0, newChildren) : null });
  }
...
var useLayoutEffect22 = Boolean(globalThis == null ? void 0 : globalThis.document) ? React15.useLayoutEffect : () => {
};
...
var toInt2 = (value) => ~~value;
var yearDivider2 = 1e4;
var monthDivider2 = 100;
var padTwo2 = (v) => `${v}`.padStart(2, "0");
var padFour2 = (v) => `${v}`.padStart(4, "0");
var padFourNumber = (v) => `${v}`.padStart(4, "0");
var stringDateFormatter2 = ({ year, month, date }) => `${padFour2(year)}-${padTwo2(month)}-${padTwo2(date)}`;
var getDateFromNumber2 = (n) => {
  const year = toInt2(n / yearDivider2);
  const month = toInt2(n % yearDivider2 / monthDivider2);
  const date = n % (yearDivider2 / monthDivider2);
  const dateData = { year, month, date };
  return {
    ...dateData,
    toString: () => stringDateFormatter2(dateData)
  };
};
var getStartYearAD = () => findADfromBS(getDateFromNumber2(startDateBS).toString());
var getEndYearAD = () => findADfromBS(
  stringDateFormatter2({
    year: getDateFromNumber2(startDateBS).year + yearMonthDays.length - 1,
    month: 12,
    date: yearMonthDays[yearMonthDays.length - 1][11]
  })
);
var getBSYearIndexFromBS2 = (year) => {
  const startBSYear = getDateFromNumber2(startDateBS).year;
  if (year < startBSYear) {
    throw new Error(`Invalid year, year should be greater than ${startBSYear}`);
  }
  return year - startBSYear;
...
var getMonthInfo = ({
  ...
  const getPrevMonthDays = (yearIndex = 0) => {
    ...
    try {
      ...
      if (m2 < 0) {
        m2 = 11;
        monthDays = yearMonthDays[yearIndex - 1][m2];
      } else {
        monthDays = yearMonthDays[yearIndex][m2];
      }
    } catch (err) {
      monthDays = 0;
    }
  ...
  switch (type) {
    case "AD": {
      ...
      const firstWeekDay = new Date(
        stringDateFormatter2({ year, month, date: 1 })
      ).getDay();
      return {
    ...
    case "BS":
    default: {
      const yearIndex = getBSYearIndexFromBS2(year);
      const engYear = findADfromBS(stringDateFormatter2({ year, month, date: 1 }));
...
var getYearsArray = (startYear) => {
  return Array.from({ length: 10 }, (_, i) => {
    return startYear + i;
  });
};
var getDecadeRange = (year) => {
...
var engToNepaliNumber2 = (number2) => {
  return number2.toString().split("").map((n) => NEPALI_DIGITS[n]).join("");
};
var engToNepNumberFullDate2 = (date) => {
  return date.split("").map((d) => {
    if (d !== "-") {
      return NEPALI_DIGITS[d];
    }
...
var groupArray = (array, groupSize) => {
  const result = [];
...
var PreviousIcon = ({ size = 16 }) => {
  return (0, import_jsx_runtime4.jsxs)(
    "svg",
    {
      ...
      focusable: false,
      children: [
        (0, import_jsx_runtime4.jsx)("g", { id: "SVGRepo_bgCarrier", strokeWidth: "0" }),
        ...
        (0, import_jsx_runtime4.jsx)("g", { id: "SVGRepo_iconCarrier", children: (0, import_jsx_runtime4.jsx)(
          "path",
          {
            d: "M15 6L9 12L15 18",
            stroke: "currentColor",
...
var Menu = ({
  ...
  const [selectionMode, setSelectionMode] = (0, import_react46.useState)("day");
  const [currentYearRangeIndex, setCurrentYearRangeIndex] = (0, import_react46.useState)(0);
  const [days, setDays] = (0, import_react46.useState)([]);
  const [selectedMonthYear, setSelectedMonthYear] = (0, import_react46.useState)();
  const [adDateRangeForConverter, setAdDateRangeForConverter] = (0, import_react46.useState)({
    start: getStartYearAD(),
    end: getEndYearAD()
  });
  const todayText = lang === "en" ? "Today" : NEPALI_TODAY;
  const changeMonth = ({ m: m2, y }) => {
  ...
  const nextYear = () => {
    ...
    const y = selectedMonthYear.year + 1;
    const m2 = selectedMonthYear.month;
    if (canGoNextYear()) {
      changeMonth({
        y,
        m: m2
  ...
  const canGoPrevYear = () => {
    ...
    if (type === "AD") {
      if ((/* @__PURE__ */ new Date(
        `${padFourNumber(y)}-${padTwo2(selectedMonthYear.month + 1)}-01`
      )).getTime() > lowerADDate) {
        return true;
      }
      return false;
  ...
  const prevYear = () => {
    const y = ((selectedMonthYear == null ? void 0 : selectedMonthYear.year) || 0) - 1;
    const m2 = (selectedMonthYear == null ? void 0 : selectedMonthYear.month) || 0;
    if (canGoPrevYear()) {
      changeMonth({
        y,
        m: m2
  ...
  const canGoPrevDecade = () => {
    ...
    if (type === "AD") {
      if ((/* @__PURE__ */ new Date(
        `${padFourNumber(currentYearRangeIndex)}-${padTwo2(selectedMonthYear.month + 1)}-01`
      )).getTime() > lowerADDate) {
        return true;
      }
      return false;
  ...
  const canGoPrevMonth = () => {
    ...
    if (type === "AD") {
      if ((/* @__PURE__ */ new Date(
        `${padFourNumber(selectedMonthYear.year)}-${padTwo2(selectedMonthYear.month + 1)}-01`
      )).getTime() > lowerADDate) {
        return true;
      }
      return false;
    }
    const startBSYear = getDateFromNumber2(startDateBS);
    if (selectedMonthYear) {
  ...
  const prevMonth = () => {
    ...
    let m2 = selectedMonthYear.month - 1;
  ...
  const isSelectedDate = (date, month) => {
    if (!selectedDate || !selectedMonthYear) {
      return false;
    }
    return selectedDate.getFullYear() === selectedMonthYear.year && selectedDate.getMonth() === selectedMonthYear.month && selectedDate.getDate() === date && month === "current";
  };
  const isTodayDate = (date) => {
    if (!today || !selectedMonthYear) {
      return false;
    }
    return today.getFullYear() === selectedMonthYear.year && today.getMonth() === selectedMonthYear.month && date === today.getDate();
  };
  const checkDayDisabledInBs = (month) => {
    if (!selectedMonthYear) {
      return true;
    }
    const startBSYear = getDateFromNumber2(startDateBS);
    const endBSYear = startBSYear.year + yearMonthDays.length - 1;
    let m2 = selectedMonthYear.month;
    let y = selectedMonthYear.year;
    if (type === "BS") {
      switch (month) {
        case "next": {
  ...
  const checkDayDisabledInAD = (month) => {
    if (!selectedMonthYear) {
      return true;
    }
    let m2 = selectedMonthYear.month;
  ...
  const handleOnChange = (month, date) => {
    if (!selectedMonthYear) {
      return;
    }
    let m2 = selectedMonthYear.month;
    ...
    const x = `${padFourNumber(y)}-${padTwo2(m2 + 1)}-${padTwo2(date)}`;
    onChange == null ? void 0 : onChange(
      // @ts-ignore
      type === "BS" ? new nepali_date_default2(y, m2, date) : new Date(x)
    );
  };
  const getSelectionContent = (0, import_react46.useMemo)(() => {
    const num_columns = 3;
    switch (selectionMode) {
      case "month": {
        ...
        const getMonthIndex = (index2, mIndex) => index2 * num_columns + mIndex;
        const onMonthClicked = (index2, mIndex) => {
          changeMonth({
            m: getMonthIndex(index2, mIndex),
            y: (selectedMonthYear == null ? void 0 : selectedMonthYear.year) || 0
          });
          setSelectionMode("day");
        };
        const isMonthDisabled = (month) => {
          ...
          if (min) {
            if ((selectedMonthYear == null ? void 0 : selectedMonthYear.year) === min.getFullYear() && month < min.getMonth() || (selectedMonthYear == null ? void 0 : selectedMonthYear.year) < min.getFullYear()) {
              return true;
            }
          }
          if (max) {
            if ((selectedMonthYear == null ? void 0 : selectedMonthYear.year) === max.getFullYear() && month > max.getMonth() || (selectedMonthYear == null ? void 0 : selectedMonthYear.year) > max.getFullYear()) {
              return true;
            }
          }
          if (!converterMode) {
          ...
          if (selectedMonthYear.year < adDateRangeForConverter.start.year || selectedMonthYear.year > adDateRangeForConverter.end.year) {
            return true;
          }
          if (selectedMonthYear.year === adDateRangeForConverter.start.year || selectedMonthYear.year === adDateRangeForConverter.end.year) {
            if (selectedMonthYear.year === adDateRangeForConverter.start.year && month < adDateRangeForConverter.start.month || selectedMonthYear.year === adDateRangeForConverter.end.year && month > adDateRangeForConverter.end.month) {
              return true;
            }
            return false;
          }
        ...
        return (0, import_jsx_runtime5.jsx)("tbody", { children: monthArray.map((ma, index2) => {
          const i = index2;
          return (0, import_jsx_runtime5.jsx)("tr", { children: ma.map((m2, mIndex) => {
            const monthIndex = getMonthIndex(index2, mIndex);
            const monthDisabled = isMonthDisabled(monthIndex);
            return (0, import_jsx_runtime5.jsx)("td", { children: (components == null ? void 0 : components.month) ? components.month({
              onClick: () => !monthDisabled ? onMonthClicked(index2, mIndex) : null,
              monthText: m2,
              monthNumber: monthIndex,
              year: (selectedMonthYear == null ? void 0 : selectedMonthYear.year) || 0,
                ...
                children: (0, import_jsx_runtime5.jsx)(
                  "div",
                  {
                    className: cn(
                      ...
                      {
                        "group-hover:zener-bg-menu-container-item-hover": !monthDisabled,
                        "zener-text-menu-container-text-disabled": monthDisabled
                      }
                    ),
                    children: m2
                  }
      ...
      case "year": {
        ...
        const getYearIndex = (index2, mIndex) => index2 * num_columns + mIndex;
        const onYearClicked = (index2, mIndex) => {
          changeMonth({
            m: (selectedMonthYear == null ? void 0 : selectedMonthYear.month) || 0,
            y: getYearIndex(index2, mIndex) + range.start
          });
        ...
        const isYearDisabled = (year) => {
          ...
          if (year < adDateRangeForConverter.start.year || year > adDateRangeForConverter.end.year) {
            return true;
          }
          return false;
        };
        return (0, import_jsx_runtime5.jsx)("tbody", { children: groupedYears.map((ma, index2) => {
          const i = index2;
          return (0, import_jsx_runtime5.jsx)("tr", { children: ma.map((m2, mIndex) => {
            const yearText = lang === "en" ? padFourNumber(m2) : engToNepaliNumber2(padFourNumber(m2));
            const indexNumber = getYearIndex(index2, mIndex) + range.start;
            const yearDisabled = isYearDisabled(indexNumber);
            return (0, import_jsx_runtime5.jsx)("td", { children: (components == null ? void 0 : components.year) ? components.year({
              onClick: () => !yearDisabled ? onYearClicked(index2, mIndex) : null,
              yearText,
                ...
                children: (0, import_jsx_runtime5.jsx)(
                  "div",
                  {
                    className: cn(
                      "zener-text-sm zener-flex zener-items-center zener-justify-center zener-h-[28px] zener-rounded",
                      {
                        "group-hover:zener-bg-menu-container-item-hover": !yearDisabled,
                        "zener-text-menu-container-text-disabled": yearDisabled
                      }
                    ),
                    children: yearText
                  }
      ...
      case "day":
      default: {
        const onDayClicked = (month, date) => handleOnChange(month, date);
        const isDayDisabled = (day, month) => {
          if (!selectedMonthYear) {
            return true;
          }
          if (min) {
            if ((selectedMonthYear == null ? void 0 : selectedMonthYear.year) === min.getFullYear() && (selectedMonthYear == null ? void 0 : selectedMonthYear.month) === min.getMonth() && (day < min.getDate() && month !== "next" || month === "prev") || selectedMonthYear.month < min.getMonth() && selectedMonthYear.year === min.getFullYear() || selectedMonthYear.year < min.getFullYear()) {
              return true;
            }
          }
          if (max) {
            if ((selectedMonthYear == null ? void 0 : selectedMonthYear.year) === max.getFullYear() && (selectedMonthYear == null ? void 0 : selectedMonthYear.month) === max.getMonth() && (day > max.getDate() && month !== "prev" || month === "next") || selectedMonthYear.month > max.getMonth() && selectedMonthYear.year === max.getFullYear() || selectedMonthYear.year > max.getFullYear()) {
              return true;
            }
          }
          if (type === "BS") {
          ...
          if (selectedMonthYear.year === adDateRangeForConverter.start.year || selectedMonthYear.year === adDateRangeForConverter.end.year) {
            if (selectedMonthYear.year === adDateRangeForConverter.start.year && selectedMonthYear.month < adDateRangeForConverter.start.month || selectedMonthYear.year === adDateRangeForConverter.end.year && selectedMonthYear.month > adDateRangeForConverter.end.month) {
              return true;
            }
            if (selectedMonthYear.year === adDateRangeForConverter.start.year && selectedMonthYear.month === adDateRangeForConverter.start.month && (day < adDateRangeForConverter.start.date && month === "current" || month === "prev") || selectedMonthYear.year === adDateRangeForConverter.end.year && selectedMonthYear.month === adDateRangeForConverter.end.month && adDateRangeForConverter.start.month && (day > adDateRangeForConverter.end.date && month === "current" || month === "next")) {
              return true;
            }
            return false;
          }
        ...
        return (0, import_jsx_runtime5.jsxs)(import_jsx_runtime5.Fragment, { children: [
          (0, import_jsx_runtime5.jsx)("thead", { children: (0, import_jsx_runtime5.jsx)("tr", { className: "zener-text-sm", children: (lang === "en" ? ENGLISH_WEEK : NEPALI_WEEK).map(
            (week, index2) => (0, import_jsx_runtime5.jsx)("th", { children: (components == null ? void 0 : components.week) ? components.week({ weekText: week, weekNumber: index2 }) : (0, import_jsx_runtime5.jsx)("div", { className: "zener-w-[28px] zener-h-[28px] zener-flex zener-items-center zener-justify-center zener-font-normal", children: week }) }, week)
          ) }) }),
          (0, import_jsx_runtime5.jsx)("tbody", { children: days.map((d, i) => {
            const ii = i;
            return (0, import_jsx_runtime5.jsx)("tr", { children: d.map((dd, index2) => {
              const date = dd.day < 1 ? 0 : dd.day;
              const isSelected = isSelectedDate(date, dd.month);
              const isToday = isTodayDate(date);
              const dateText = lang === "en" ? date : engToNepaliNumber2(date);
              const dayDisabled = isDayDisabled(date, dd.month);
              return (0, import_jsx_runtime5.jsx)("td", { children: (components == null ? void 0 : components.date) ? components.date({
                dateMonthType: dd.month,
                dateText,
                date,
                month: (selectedMonthYear == null ? void 0 : selectedMonthYear.month) || 0,
                year: (selectedMonthYear == null ? void 0 : selectedMonthYear.year) || 0,
                isSelected,
                isToday,
                onClick: () => !dayDisabled ? onDayClicked(dd.month, date) : null,
                  ...
                  children: (0, import_jsx_runtime5.jsx)(
                    "div",
                    {
                      className: cn(
                        ...
                        {
                          "zener-text-menu-container-text-disabled": dd.month !== "current" || dayDisabled,
                          "zener-border zener-border-solid zener-box-border zener-border-menu-container-text-border": isToday && dd.month === "current" && !dayDisabled,
                          "zener-bg-menu-container-text-selected-bg zener-text-menu-container-text-selected zener-transition-none": isSelected && dd.month === "current" && !dayDisabled,
                          "zener-bg-menu-container-text-selected-disabled-bg zener-text-menu-container-text-selected-disabled zener-transition-none": isSelected && dd.month === "current" && dayDisabled,
                          "group-hover:zener-bg-menu-container-item-hover": !isSelected && !dayDisabled
                        }
                      ),
                      children: dateText
                    }
  ...
  const getYearRange = (0, import_react46.useMemo)(() => {
    ...
    return lang === "en" ? yearRange : engToNepNumberFullDate2(yearRange);
  ...
  const getHeaderYearText = () => {
    return lang === "en" ? padFourNumber((selectedMonthYear == null ? void 0 : selectedMonthYear.year) || 1) : engToNepaliNumber2(padFourNumber((selectedMonthYear == null ? void 0 : selectedMonthYear.year) || 1));
  };
  const getHeaderMonthText = () => {
    if (type === "BS") {
      return (lang === "en" ? ENGLISH_NEPALI_MONTH : NEPALI_MONTH)[(selectedMonthYear == null ? void 0 : selectedMonthYear.month) || 0];
    } else {
      return (lang === "en" ? AD_MONTH : AD_MONTH_NEPALI)[(selectedMonthYear == null ? void 0 : selectedMonthYear.month) || 0];
    }
  };
  const selectToday = () => {
    onChange == null ? void 0 : onChange(today);
  };
  return (0, import_jsx_runtime5.jsx)(AnimatePresence, { children: show && (0, import_jsx_runtime5.jsx)(
    Portal,
    {
      tabIndex: -1,
      className: cn(
      ...
      children: (0, import_jsx_runtime5.jsxs)(
        motion.div,
        {
          ...
          className: cn(
            ...
            menuContainerClassName || "zener-bg-menu-container-bg zener-rounded-md zener-shadow-menu zener-text-menu-container-text"
          ),
          children: [
            (components == null ? void 0 : components.header) ? components.header({
              ...
              monthNumber: (selectedMonthYear == null ? void 0 : selectedMonthYear.month) || 0,
              yearRange: getDecadeRange(currentYearRangeIndex),
              yearNumber: (selectedMonthYear == null ? void 0 : selectedMonthYear.year) || 0,
              yearRangeText: getYearRange
            }) : (0, import_jsx_runtime5.jsxs)("div", { className: "zener-flex zener-flex-row zener-items-center zener-text-sm zener-justify-between zener-py-2 zener-border-0 zener-border-b zener-border-b-menu-container-top-bottom-border zener-border-solid", children: [
              (0, import_jsx_runtime5.jsx)(
                "button",
                {
                  className: cn(
                  ...
                  tabIndex: -1,
                  children: (0, import_jsx_runtime5.jsx)(PreviousIcon, { size: 20 })
                }
              ),
              (selectionMode === "day" || selectionMode === "month") && (0, import_jsx_runtime5.jsxs)("div", { className: "zener-font-semibold zener-flex zener-flex-row zener-items-center", children: [
                selectionMode === "day" && (0, import_jsx_runtime5.jsx)(
                  "button",
                  {
                    tabIndex: -1,
                ...
                (0, import_jsx_runtime5.jsx)(
                  "button",
                  {
                    ...
                    children: getHeaderYearText()
                  }
                )
              ] }),
              selectionMode === "year" && (0, import_jsx_runtime5.jsx)("div", { className: "zener-cursor-default zener-font-semibold zener-flex zener-flex-row zener-items-center", children: getYearRange }),
              (0, import_jsx_runtime5.jsx)(
                "button",
                {
                  className: cn(
                  ...
                  onClick: onNextClick,
                  children: (0, import_jsx_runtime5.jsx)(NextIcon, { size: 20 })
                }
              )
            ] }),
            (0, import_jsx_runtime5.jsx)("div", { className: cn(calendarClassName || "zener-p-2"), children: (0, import_jsx_runtime5.jsx)("table", { className: "zener-w-full zener-h-full zener-border-collapse", children: getSelectionContent }) }),
            (components == null ? void 0 : components.footer) ? components.footer({
              onTodayClick: selectToday,
              todayText
            }) : (0, import_jsx_runtime5.jsx)("div", { className: "zener-flex zener-flex-row zener-items-center zener-justify-center zener-border-0 zener-border-t zener-border-solid zener-border-t-menu-container-top-bottom-border", children: (0, import_jsx_runtime5.jsx)(
              "button",
              {
...
var useBounds = (inputRef, deps) => {
  const [bounds, setBounds] = (0, import_react47.useState)({
    left: 0,
    top: 0,
    height: 0,
    width: 0
  });
  const boundRef = (0, import_react47.useRef)({
    left: 0,
    top: 0,
    height: 0,
    width: 0
...
var use_bounds_default = useBounds;
var NepaliDatePicker = ({
  ...
  const portalRef = (0, import_react45.useRef)(null);
  ...
  const [today, setToday] = (0, import_react45.useState)(
    type === "BS" ? new nepali_date_default2() : /* @__PURE__ */ new Date()
  );
  const { bounds } = use_bounds_default(containerRef, [show, open]);
  (0, import_react45.useEffect)(() => {
    setToday(type === "BS" ? new nepali_date_default2() : /* @__PURE__ */ new Date());
  }, []);
  (0, import_react45.useEffect)(() => {
    setToday(type === "BS" ? new nepali_date_default2() : /* @__PURE__ */ new Date());
  }, [type]);
  (0, import_react45.useEffect)(() => {
    if (selectedDate) {
      if (type === "BS") {
        setInputValue(selectedDate.format(format, lang));
      } else {
        setInputValue(formatADDate(selectedDate, format, lang));
      }
    } else {
      setInputValue("");
    }
  ...
  (0, import_react45.useEffect)(() => {
    if (value) {
      switch (type) {
        ...
        case "BS":
        default:
          if (typeof value === "string" || value instanceof nepali_date_default2) {
            setSelectedDate(new nepali_date_default2(value));
          }
          break;
      }
    } else {
  ...
  const setFocus = () => {
    ...
    if (className && typeof className === "function" && !!className().focus) {
      (_b = containerRef.current) == null ? void 0 : _b.classList.add(
        ...((_a2 = className().focus) == null ? void 0 : _a2.split(" ")) || [""]
      );
    }
  };
  const removeFocus = () => {
    var _a2, _b, _c, _d;
    if (className && typeof className === "function" && !!className().focus) {
      (_b = containerRef.current) == null ? void 0 : _b.classList.remove(
        ...((_a2 = className().focus) == null ? void 0 : _a2.split(" ")) || [""]
      );
      (_d = containerRef.current) == null ? void 0 : _d.classList.add(
        ...((_c = className().default) == null ? void 0 : _c.split(" ")) || [""]
      );
    }
  };
  const clear = () => {
  ...
  return (0, import_jsx_runtime6.jsxs)("div", { className: "zener-w-full", children: [
    (0, import_jsx_runtime6.jsxs)(
      "div",
      {
        ...
        className: cn(
          ...
          {
            "zener-text-input-disabled-text zener-bg-input-disabled-bg zener-border-input-disabled-border": !className && !!disabled
          },
          className && typeof className === "function" ? `${disabled ? className().disabled : className().default}` : className || `${!disabled ? "focus:zener-ring-1 focus:zener-ring-input-focus-ring focus-within:zener-ring-1 focus-within:zener-ring-input-focus-ring" : ""} zener-font-sans zener-bg-input-bg zener-text-sm zener-px-2 zener-py-0.5 zener-border-solid zener-border zener-border-input-border zener-rounded zener-min-w-[122px] zener-outline-none zener-w-full zener-text-input-text`
        ),
        onFocus: () => {
          if (disabled) {
            return;
        ...
        children: [
          prefix && (0, import_jsx_runtime6.jsx)("div", { children: prefix }),
          (0, import_jsx_runtime6.jsx)(
            "input",
            {
              ...
              onBlur: (e) => {
                ...
                const isInMenu = (_a2 = portalRef.current) == null ? void 0 : _a2.contains(rT);
                if (isInMenu) {
          ...
          (suffix == null ? void 0 : suffix({
            ...
            "div",
            {
              ...
              children: showclear && !disabled && !!inputValue && (0, import_jsx_runtime6.jsx)(
                "button",
                {
                  "aria-label": "clear",
                  onClick: (e) => {
                  ...
                  children: (0, import_jsx_runtime6.jsx)(CloseIcon, { size: 16 })
                }
              )
            }
          )
...
var nepali_date_picker_default = NepaliDatePicker;
var {
  AD_MONTH: AD_MONTH2,
  AD_MONTH_FULL: AD_MONTH_FULL2,
  AD_MONTH_NEPALI: AD_MONTH_NEPALI2,
  ENGLISH_NEPALI_MONTH: ENGLISH_NEPALI_MONTH2,
  ENGLISH_WEEK: ENGLISH_WEEK2,
  ENGLISH_WEEK_FULL: ENGLISH_WEEK_FULL2,
  lowerADDate: lowerADDate2,
  NEPALI_DIGITS: NEPALI_DIGITS2,
  NEPALI_MONTH: NEPALI_MONTH2,
  NEPALI_TODAY: NEPALI_TODAY2,
  NEPALI_WEEK: NEPALI_WEEK2,
  NEPALI_WEEK_FULL: NEPALI_WEEK_FULL2,
  startDateBS: startDateBS3,
  toAD: toAD2,
  toBS,
  yearMonthDays: yearMonthDays3
} = dist_exports;
var datepicker_default = nepali_date_picker_default;
export {
  AD_MONTH2 as AD_MONTH,
  AD_MONTH_FULL2 as AD_MONTH_FULL,
  AD_MONTH_NEPALI2 as AD_MONTH_NEPALI,
  ENGLISH_NEPALI_MONTH2 as ENGLISH_NEPALI_MONTH,
  ENGLISH_WEEK2 as ENGLISH_WEEK,
  ENGLISH_WEEK_FULL2 as ENGLISH_WEEK_FULL,
  NEPALI_DIGITS2 as NEPALI_DIGITS,
  NEPALI_MONTH2 as NEPALI_MONTH,
  NEPALI_TODAY2 as NEPALI_TODAY,
  NEPALI_WEEK2 as NEPALI_WEEK,
  NEPALI_WEEK_FULL2 as NEPALI_WEEK_FULL,
  nepali_date_default2 as NepaliDate,
  datepicker_default as default,
  lowerADDate2 as lowerADDate,
  startDateBS3 as startDateBS,
  toAD2 as toAD,
  toBS,
  yearMonthDays3 as yearMonthDays
};
...
classnames/index.js:
  ...
  *)
*/
//# sourceMappingURL=@zener_nepali-datepicker-react.js.map
