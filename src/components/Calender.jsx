    ...
    <div className="max-w-80 flex flex-col items-center bg-base-50">
      <div className="bg-base-200 rounded-lg w-full max-w-md">
        ...
        <div className="flex items-center justify-between px-2 py-3 mb-2">
          <button onClick={handlePrevMonth} className="btn btn-ghost btn-xs">
            <CaretLeft size={22} />
          </button>
          ...
          <button onClick={handleNextMonth} className="btn btn-ghost btn-xs">
            <CaretRight size={22} />
          </button>
        </div>
        <div>
              ...
              <div
                ...
                className={`text-xs h-12 flex flex-col items-center justify-center rounded-md px-1 ${
                  !dayObj
                    ...
                    ? "hover: bg-red-700 text-white font-semibold border border-base-100"
                    : "hover: border hover:border-red-100 hover:bg-red-100 text-base-600 hover:bg-base-200"
                }`}
              >
