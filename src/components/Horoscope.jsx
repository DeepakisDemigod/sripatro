          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4'>
            {zodiacSigns.map(({ sign, emoji }) =>
              horoscopeData[sign] ? (
                <div
                  key={sign}
                  className='p-4 bg-base-300 rounded-lg shadow'
                >
                  <div className='flex items-center justify-between'>
                    ...
                    <button onClick={() => toggleSpeech(sign)}>
                      {activeSign === sign && speechStatus === 'started' ? (
                        <div className='bg-red-600 rounded-full p-2 text-base-content'>
                          <Pause
                            size={21}
                            weight='bold'
                        ...
                        <div className='btn bg-red-600 rounded-full p-2 text-base-content'>
                          <Play
                            size={21}
                            weight='bold'
                            className='text-base-content'
