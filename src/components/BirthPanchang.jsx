  ...
  return (
    <div className='bg-base-100 text-base-content flex items-center justify-center'>
      <div className=' p-6 w-full'>
        <div className='md:flex gap-4 bg-base-100 rounded-lg p-2 max-w-6xl w-full'>
        

          <div>
            <a
              href='https://sripatro.com'
              ...
              <div className='mt-2 px-2 flex flex-col justify-between bg-base-100 rounded-md border border-2 border-base-800 border-t-red-600'>
                <div>
                  ...
                  <p className='text-xs px-.5'>
                    change nepali date to indian date and indian date to nepali
                    date.
                  </p>
                </div>
                <a className='my-2 border border-base-500 flex text-sm bg-base-900 items-center gap-2 text-base-800 rounded-md shadow-sm transition'>
                  <div className=''>
