...
function Kundali() {
  ...
  return (
    <div className="bg-gray-50  flex items-center justify-center py-10 px-5">
      <div
        className="bg-white border border-t-blue-500 shadow-lg rounded-lg p-6 w-full max-w-6xl mx-auto"
        ref={kundaliRef}
      >
        <h2 className="text-2xl flex items-center justify-between font-semibold text-gray-800 mb-6">
          <span> Lagna Kundali Chart (D1) </span>
          <button
            className="mt-4 bg-blue-500 hover:bg-blue-700 text-md text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline flex items-center justify-evenly gap-2"
            type="button"
          ...
          {/* Share Buttons */}
          <div className="mt-4 flex gap-3 justify-center border border-blue-500 rounded p-2 ">
            <WhatsappLogo
              size={32}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <input
                ...
                className="mt-1 block w-full border border-gray-300 rounded-md shadow-sm py-2 px-3 focus:ring-blue-500 focus:outline-none"
              />
            </div>
        ...
        <div className="mt-8 overflow-x-auto">
          <table className="min-w-full leading-normal">
            <thead>
              <tr>
                <th className="p-2  bg-blue-500 text-white text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                  Planet Name
                </th>
                <th className="p-2 bg-blue-500 text-white text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">
                  Sign
